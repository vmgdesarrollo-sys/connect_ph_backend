...
import { CreateUserRolDto } from '../dtos/payload/voting_questions-payload.dto';
...
export class VotingQuestionsController {
  constructor(private readonly userRolesService: VotingQuestionsService) {}
