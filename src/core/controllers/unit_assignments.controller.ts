...
import { CreateUserRolDto } from '../dtos/payload/unit_assignment-payload.dto';
...
export class UnitAssignmentsController {
  ...
  async assingRol(@Param("userRolId", ParseUUIDPipe) id: string, @Body() createUserRolDto: CreateUserRolDto) {
    return await this.unitAssignmentsService.assingRol(id, createUserRolDto); 
  }
