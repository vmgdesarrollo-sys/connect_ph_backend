...
import { CreateUserRolDto } from '../dtos/payload/assembly_announcements-payload.dto';
...
export class AssemblyAnnouncementsController {
  constructor(private readonly userRolesService: AssemblyAnnouncementsService) {}
