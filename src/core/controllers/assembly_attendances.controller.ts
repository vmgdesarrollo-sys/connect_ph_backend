...
import { CreateUserRolDto } from '../dtos/payload/assembly_attendances-payload.dto';
...
@Controller("assembly_attendances")
...
export class AssemblyAttendancesController {
  constructor(private readonly userRolesService: AssemblyAttendancesService) {}
